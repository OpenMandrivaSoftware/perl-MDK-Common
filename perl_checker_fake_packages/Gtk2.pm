...
sub Gtk2::append_item { my ($_self, $_text, $_tooltip, $_private, $_icon, $_callback, $_user_data) = @_ }
...
sub Gtk2::black_gc { my ($_self, $_set) = @_ }
...
sub Gtk2::fraction { my ($_self, $_frac) = @_ }
...
sub Gtk2::idle_add { my ($_DUMMY0, $_DUMMY1, $_DUMMY2) = @_ }
sub Gtk2::idle_remove { my ($_DUMMY0, $_DUMMY1) = @_ }
...
sub Gtk2::orientation { my ($_self, $_ori) = @_ }
...
sub Gtk2::timeout_add { my ($_DUMMY0, $_DUMMY1, $_DUMMY2, $_DUMMY3) = @_ }
sub Gtk2::timeout_remove { my ($_DUMMY0, $_DUMMY1) = @_ }
sub Gtk2::to_string { my ($_path) = @_ }
sub Gtk2::toggle { my ($_item) = @_ }
sub Gtk2::toggle_add_mode { my ($_list) = @_ }
sub Gtk2::toggle_expansion { my ($_self, $_path, $_open_all) = @_ }
...
sub Gtk2::white_gc { my ($_self, $_set) = @_ }
